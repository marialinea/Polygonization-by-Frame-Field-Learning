...
def save_plot_framefield(framefield, out_filepath):
    ...
    #height = framefield.shape[0][0]
    #width = framefield.shape[0][1]
    ...
    framefield_stride = 8
    plot_utils.plot_crossfield(axis, framefield, framefield_stride, alpha=1, width=2)
...
def main():
    ...
    # Read
    framefield = np.load(args.filepath, allow_pickle=True)
